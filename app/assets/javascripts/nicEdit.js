...
var nicEditorInstance = bkClass.extend({
  ...
  construct:function (e, options, nicEditor) {
    ...
    if (isTextarea || this.options.hasPanel) {
      ...
      if (isTextarea) {
        ...
        if (f) {
          bkLib.addEvent(f, 'submit', $.proxy(this.saveContent, this));
        }
      }
      editorElm.setStyle((ie7s) ? {height:newY + 'px'} : {overflow:'hidden'});
      this.elm = editorElm;
    }
    this.ne.addEvent('blur', $.proxy(this.blur, this));
  ...
  init:function () {
    ...
    this.elm.addEvent('mousedown', this.selected.closureListener(this)).addEvent('keypress', this.keyDown.closureListener(this)).addEvent('focus', $.proxy(this.selected, this)).addEvent('blur', $.proxy(this.blur, this)).addEvent('keyup', $.proxy(this.selected, this));
...
var nicEditorIFrameInstance = nicEditorInstance.extend({
  ...
  init:function () {
    ...
    setTimeout($.proxy(this.initFrame, this), 50);
  },
  ...
  initFrame:function () {
    ...
    this.heightUpdate();
    this.frameDoc.addEvent('mousedown', this.selected.closureListener(this)).addEvent('keyup', this.heightUpdate.closureListener(this)).addEvent('keydown', this.keyDown.closureListener(this)).addEvent('keyup', $.proxy(this.selected, this));
    this.ne.fireEvent('add', this);
  },
  ...
  nicCommand:function (cmd, args) {
    ...
    setTimeout($.proxy(this.heightUpdate, this), 100);
  }
...
var nicEditorButton = bkClass.extend({
  ...
  construct:function (e, buttonName, options, nicEditor) {
    ...
    this.button.addEvent('mouseover', $.proxy(this.hoverOn, this)).addEvent('mouseout', $.proxy(this.hoverOff, this)).addEvent('mousedown', $.proxy(this.mouseClick, this)).noSelect();

    if (!window.opera) {
      this.button.onmousedown = this.button.onclick = bkLib.cancelEvent;
    }

    nicEditor.addEvent('selected', $.proxy(this.enable, this)).addEvent('blur', $.proxy(this.disable, this)).addEvent('key', $.proxy(this.key, this));
  ...
  disable:function (ins, t) {
    ...
    $(this.contain).css('opacity','0.6').removeClass('buttonEnabled');
    this.updateState();
  },
...
var nicPlugin = bkClass.extend({
  ...
  construct:function (nicEditor, options) {
    this.options = options;
    this.ne = nicEditor;
    this.ne.addEvent('panel', $.proxy(this.loadPanel, this));
...
var nicEditorPane = bkClass.extend({
  construct:function (elm, nicEditor, options, openButton) {
    ...
    if (openButton && !openButton.options.noClose) {
      this.close = new bkElement('div').setStyle({'float':'right', height:'16px', width:'16px', cursor:'pointer'}).setStyle(this.ne.getIcon('close', nicPaneOptions)).addEvent('mousedown', $.proxy(openButton.removePane, this)).appendTo(this.pane);
    }
...
var nicEditorAdvancedButton = nicEditorButton.extend({
  ...
  init:function () {
    this.ne.addEvent('selected', $.proxy(this.removePane, this)).addEvent('blur', $.proxy(this.removePane, this));
  },
...
var nicButtonTips = bkClass.extend({
  construct:function (nicEditor) {
    this.ne = nicEditor;
    nicEditor.addEvent('buttonOver', $.proxy(this.show, this)).addEvent('buttonOut', $.proxy(this.hide, this));
...
var nicEditorSelect = bkClass.extend({
  ...
  construct:function (e, buttonName, options, nicEditor) {
    ...
    this.contain = new bkElement('div').setStyle({width:'90px', height:'20px', cursor:'pointer', overflow:'hidden'}).addClass('selectContain').addEvent('click', $.proxy(this.toggle, this)).appendTo(this.margin);
    ...
    this.ne.addEvent('selected', $.proxy(this.enable, this)).addEvent('blur', $.proxy(this.disable, this));
...
var nicUploadButton = nicEditorAdvancedButton.extend({
  ...
  addPane:function () {
    ...
    setTimeout($.proxy(this.addForm, this), 50);
  },
  ...
  addForm:function () {
    ...
    myDoc.write('<input name="image[image_file]" type="file" style="margin-top: 10px;" />');
    myDoc.write('</form>');
    ...
    this.myInput = $BK(this.myBody.getElementsByTagName('input')[0]).addEvent('change', $.proxy(this.startUpload, this));
  ...
  startUpload:function () {
    ...
    $(this.myForm).ajaxSubmit({success:$.proxy(this.update, this)});
  },

  makeRequest:function () {
    if (this.pane && this.pane.pane) {
      nicUploadButton.lastPlugin = this;
      var s = new bkElement('script').setAttributes({ type:'text/javascript', src:this.uri + '?check=' + this.myID }).addEvent('load',
          function () {
            s.parentNode.removeChild(s);
          }).appendTo(document.getElementsByTagName('head')[0]);
      if (this.requestInterval) {
        setTimeout($.proxy(this.makeRequest, this), this.requestInterval);
      }
    }
  },
...
var nicXHTML = bkClass.extend({
  ...
  construct:function (nicEditor) {
    ...
    if (this.ne.options.xhtml) {
      nicEditor.addEvent('get', $.proxy(this.cleanup,this));
    }
  },
...
var nicBBCode = bkClass.extend({
  construct:function (nicEditor) {
    ...
    if (this.ne.options.bbCode) {
      nicEditor.addEvent('get', $.proxy(this.bbGet,this));
      nicEditor.addEvent('set', $.proxy(this.bbSet, this));
...
nicEditor = nicEditor.extend({
  floatingPanel:function () {
    ...
    this.addEvent('focus', $.proxy(this.reposition, this)).addEvent('blur', $.proxy(this.hide, this));
